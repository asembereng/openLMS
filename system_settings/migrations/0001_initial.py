# Generated by Django 4.2.23 on 2025-07-01 22:57
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role_name",
                    models.CharField(
                        help_text="Name of the role", max_length=50, unique=True
                    ),
                ),
                (
                    "description",
                    models.TextField(help_text="Description of what this role can do"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True, help_text="Allow customers to register accounts"
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "model_name",
                    models.CharField(
                        help_text="Name of the model that was changed", max_length=100
                    ),
                ),
                (
                    "object_id",
                ...
                (
                    "user_agent",
                    models.TextField(
                        blank=True, help_text="User's browser/client information"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "smtp_password",
                    models.CharField(
                        help_text="SMTP password or app password", max_length=255
                    ),
                ),
                (
                    "use_tls",
                ...
                (
                    "last_test_error",
                    models.TextField(
                        blank=True, help_text="Error message from last failed test"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
